...
PONDS = [
    {"name": "1 號池", "species": "虱目魚", "description": "主要示範池，最近兩天溶氧偏低"},
    {"name": "2 號池", "species": "虱目魚", "description": "穩定養殖池"},
    {"name": "3 號池", "species": "白蝦", "description": "高鹽度示範池"},
]
...
class Command(BaseCommand):
    help = "Seed mock water quality data for the AI assistant."

    def add_arguments(self, parser):
        parser.add_argument("--reset", action="store_true", help="Delete existing water data first.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Seeded {len(ponds)} ponds and {created} readings."))
