...
urlpatterns = [
    ...
    path('operations/course/<int:course_id>/registrations.csv', views.course_registrations_csv, name='course_registrations_csv'),
    path('water-dashboard/', views.water_dashboard, name='water_dashboard'),
    path('api/water/history/', views.water_history_api, name='water_history_api'),
